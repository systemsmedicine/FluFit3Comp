...
__device__ void model(int idx, param pars, float *pop, comp Y, comp *dotY)
{
	...
	ii++;
	float xi1  = pow(10, pop[idx + ii]);
	ii++;
	float chi1 = pow(10, pop[idx + ii]);
	ii++;
	float del1 = pow(10, pop[idx + ii]);
	ii++;
	float rho1 = pow(10, pop[idx + ii]);
	ii++;
	float sig1 = pow(10, pop[idx + ii]);
	ii++;
	float alp1 = pow(10, pop[idx + ii]);
	ii++;
	float phi1 = pow(10, pop[idx + ii]);
	ii++;

	float bet2 = pow(10, pop[idx + ii]);
	ii++;
	float xi2  = pow(10, pop[idx + ii]);
	ii++;
	float chi2 = pow(10, pop[idx + ii]);
	ii++;
	float psi2 = pow(10, pop[idx + ii]);
	ii++;
	float del2 = pow(10, pop[idx + ii]);
	ii++;
	float rho2 = pow(10, pop[idx + ii]);
	ii++;
	float sig2 = pow(10, pop[idx + ii]);
	ii++;
	float alp2 = pow(10, pop[idx + ii]);
	ii++;
	float phi2 = pow(10, pop[idx + ii]);
	ii++;
	float eta2 = pow(10, pop[idx + ii]);
	ii++;
	float kap2 = pow(10, pop[idx + ii]);
	ii++;
	float ups2 = pow(10, pop[idx + ii]);
	ii++;

	float bet3 = pow(10, pop[idx + ii]);
	ii++;
	float xi3  = pow(10, pop[idx + ii]);
	ii++;
	float chi3 = pow(10, pop[idx + ii]);
	ii++;
	float psi3 = pow(10, pop[idx + ii]);
	ii++;
	float del3 = pow(10, pop[idx + ii]);
	ii++;
	float rho3 = pow(10, pop[idx + ii]);
	ii++;
	float sig3 = pow(10, pop[idx + ii]);
	ii++;
	float alp3 = pow(10, pop[idx + ii]);
	ii++;
	float phi3 = pow(10, pop[idx + ii]);
	ii++;
	float eta3 = pow(10, pop[idx + ii]);
	ii++;
	float kap3 = pow(10, pop[idx + ii]);
	ii++;
	float ups3 = pow(10, pop[idx + ii]);
	ii++;

	float gam12 = pow(10, pop[idx + ii]);
	ii++;
	float gam21 = pow(10, pop[idx + ii]);
	ii++;
	float gam23 = pow(10, pop[idx + ii]);
	ii++;
	float gam32 = pow(10, pop[idx + ii]);
	ii++;
	float zet23 = pow(10, pop[idx + ii]);
	ii++;
	float zet32 = pow(10, pop[idx + ii]);
	...
	if (model == 2)
	{
		dotY->U1 = -bet1*Y.U1*Y.V1 - xi1*Y.U1*Y.I1; 
		dotY->I1 = bet1*Y.U1*Y.V1 - del1*Y.I1;
		dotY->V1 = rho1*Y.I1 - sig1*Y.V1 - gam12*Y.V1 + gam21*Y.V2;

		dotY->U2 = -bet2*Y.U2*Y.V2 - xi2*Y.U2*Y.I2;
		dotY->I2 = bet2*Y.U2*Y.V2 - del2*Y.I2; 
		dotY->V2 = rho2*Y.I2 - sig2*Y.V2
			- gam21*Y.V2 + gam12*Y.V1 - gam23*Y.V2 + gam32*Y.V3;

		dotY->U3 = -bet3*Y.U3*Y.V3 - xi3*Y.U3*Y.I3;
		dotY->I3 = bet3*Y.U3*Y.V3 - del3*Y.I3; 
		dotY->V3 = rho3*Y.I3 - sig3*Y.V3 - gam32*Y.V3 + gam23*Y.V2;
	...
	if (model == 3)
	{
		dotY->U1 = -bet1*Y.U1*Y.V1 - xi1*Y.U1*Y.F1; 
		dotY->I1 = bet1*Y.U1*Y.V1 - del1*Y.I1;
		dotY->V1 = rho1*Y.I1 - sig1*Y.V1 - gam12*Y.V1 + gam21*Y.V2;
		dotY->F1 = alp1*Y.I1 - phi1*Y.F1;

		dotY->U2 = -bet2*Y.U2*Y.V2 - xi2*Y.U2*Y.F2;
		dotY->I2 = bet2*Y.U2*Y.V2 - del2*Y.I2; 
		dotY->V2 = rho2*Y.I2 - sig2*Y.V2
			- gam21*Y.V2 + gam12*Y.V1 - gam23*Y.V2 + gam32*Y.V3;
		dotY->F2 = alp2*Y.I2 - phi2*Y.F2;

		dotY->U3 = -bet3*Y.U3*Y.V3 - xi3*Y.U3*Y.F3;
		dotY->I3 = bet3*Y.U3*Y.V3 - del3*Y.I3; 
		dotY->V3 = rho3*Y.I3 - sig3*Y.V3 - gam32*Y.V3 + gam23*Y.V2;
	...
	if (model == 5) // Hereeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
	{
		dotY->U1 = -bet1*Y.U1*Y.V1 - xi1*Y.U1*Y.F1; 
		dotY->I1 = bet1*Y.U1*Y.V1 - del1*Y.I1;
		dotY->V1 = rho1*Y.I1 - sig1*Y.V1 - gam12*Y.V1 + gam21*Y.V2;
